  ...
  return (
    <figure
      className={cn(
        ...
        // hover effects
        "hover:bg-gradient-to-br hover:from-neutral-900/80 hover:to-neutral-900/40",
        "hover:shadow-lg hover:shadow-purple-500/10",
        "transition-all duration-300 ease-out",
        // spotlight effect
        "after:absolute after:inset-0 after:-z-20 after:bg-gradient-to-r",
        "after:from-purple-500/0 after:via-pink-500/10 after:to-purple-500/0",
...
export function MarqueeDemo() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-t-lg bg-background md:shadow-xl"> {/* Changed to rounded-t-lg */}
